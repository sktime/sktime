"""Same setup as linearregression.py using darts directly.

feature1 appears in both past and future covariates — darts supports this.
"""
import sklearn
import pandas as pd
...
# feature1 in both past and future covariates
past_cov = TimeSeries.from_dataframe(
    pd.DataFrame({"feature1": X[:, 0], "feature2": X[:, 1]}, index=date_idx)
)
...
print("SUCCESS: feature1 in both past and future covariates works in darts")
