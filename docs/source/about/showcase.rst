...
.. list-table::
   ...
   * - Title
     - Short Description
     - User
   * - `sktime: a unified python library for time series machine learning <https://medium.com/data-science/sktime-a-unified-python-library-for-time-series-machine-learning-3c103c139a55>`_
   ...
   * - `Time Series Analysis with sktime on AWS SageMaker <https://blog.datachef.co/time-series-analysis-sktime-sagemaker/>`_
