...
expected `format <https://github.com/sktime/sktime/blob/main/examples/data/loading-data.ipynb>`_.
...
.. _loading data: https://github.com/sktime/sktime/blob/main/examples/data/loading-data.ipynb
