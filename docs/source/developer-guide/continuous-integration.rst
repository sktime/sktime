...
For a detailed guide on code quality and linting for developers, see :ref:`coding-standards`.
...
:doc:`estimator development guide </developer-guide/add-estimators>`
