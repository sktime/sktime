...
* feel free, at any point in time, to post questions on Discord, or ask core developers for help (see here for a `list of core developers <https://www.sktime-backup.readthedocs.io/en/stable/about/team.html>`_)
