...
virtual environment along with an editable development version of ``sktime``.

For a full guide, please read the following link `Full developer setup for contributors and extension developers
