...
`developement version <https://www.sktime-backup.readthedocs.io/en/stable/installation.html>`__
 of sktime.
...
.. note::
   ...
   `installation instructions <https://www.sktime-backup.readthedocs.io/en/latest/installation.html>`__.
