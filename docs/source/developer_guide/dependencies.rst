...
*  `check_soft_dependencies.py <https://github.com/sktime/sktime/blob/main/build_tools/azure/check_soft_dependencies.py>`__,
...
*   ensure the module containing the estimator is registered
    `here <https://github.com/sktime/sktime/blob/main/build_tools/azure/check_soft_dependencies.py>`__.
