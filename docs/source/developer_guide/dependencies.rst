...
Soft dependencies are typically, but not necessarily, added with individual estimators.
...
There are specific conventions to add these in estimators, see the :ref:`new estimator developer guide <developer_guide_add_estimator>`.
