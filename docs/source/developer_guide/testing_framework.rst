...
instead of custom logic, see (pytest documentation)[https://docs.pytest.org/en/6.2.x/example/index.html].
...
See below for more details, or the (pytest documentation on the topic)[https://docs.pytest.org/en/6.2.x/parametrize.html#basic-pytest-generate-tests-example].
...
See the (pytest documentation on fixture parameterization)[https://docs.pytest.org/en/6.2.x/parametrize.html] for an explanation of fixture parameterization
in general.
...
documentation on (advanced fixture parameterization)[https://docs.pytest.org/en/6.2.x/parametrize.html#basic-pytest-generate-tests-example] using ``pytest_generate_tests``.
