...
* for explanation of tags, see the [tags reference](https://www.sktime.net/en/latest/api-reference/tags.html)
...
function fetchJsonData() {
    return fetch("_static/estimator-overview_db.json")
...
<!-- ```{include} estimator-overview_table.html
``` -->
