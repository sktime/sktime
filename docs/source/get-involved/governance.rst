...
We ask all members of the community to conform to our :ref:`code-of-conduct`.
...
the guide for implementing compatible estimators (see :ref:`developer-guide_add-estimators`).
