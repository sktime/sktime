...
You can find our mentors in our `list of contributors <https://github.com/alan-turing-institute/sktime/blob/master/CONTRIBUTORS.md>`_ by looking for the mentorship emoji: 🧑‍🏫.
...
Please also read our `Code of Conduct <https://github.com/alan-turing-institute/sktime/blob/master/CODE_OF_CONDUCT.rst>`_.

How to apply
------------

#. Make PR on `our main repo <https://github.com/alan-turing-institute/sktime>`_ or contribute to sktime in any other way. Check out our `contributing guide <https://github.com/alan-turing-institute/sktime/blob/master/CONTRIBUTING.md>`_ to get started! If you've contributed to sktime previously, you can go straight to step 2.
