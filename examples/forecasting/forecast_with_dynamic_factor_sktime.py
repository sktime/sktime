...
fh_out = ForecastingHorizon([1,2,3,4,5,6,7], is_relative=True)
...
# Create a forecasting horizon
fh_in = ForecastingHorizon([1,2, 3,4,5,6,7], is_relative=False)
...
y_pred_in_stats = fitted.predict(start=1, end=7, exog=X_train)
