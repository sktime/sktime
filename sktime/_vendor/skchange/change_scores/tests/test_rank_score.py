...
from sktime._vendor.skchange.change_scores._rank_score import direct_rank_score
from sktime._vendor.skchange.costs._rank_cost import _compute_ranks_and_pinv_cdf_cov
...
def test_change_score_distribution():
    ...
    for j, cut_point in enumerate(cut_points):
        ...
        # platform-independent: tests relaxed p-value threshold instead of strict 0.05
