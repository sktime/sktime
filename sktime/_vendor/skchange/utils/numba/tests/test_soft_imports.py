...
def test_setting_wrong_env_variable_raises():
    with (
        ...
        import sktime._vendor.skchange.utils.numba  # noqa: F401, I001


def test_setting_truthy_env_variable_does_not_raise():
    with temp_env_and_modules(
        remove_module_prefix="sktime._vendor.skchange", env_vars={"NUMBA_FASTMATH": "1"}
    ):
        import sktime._vendor.skchange.utils.numba  # noqa: F401, I001
...
def test_setting_falsy_env_variable_does_not_raise():
    with temp_env_and_modules(
        remove_module_prefix="sktime._vendor.skchange", env_vars={"NUMBA_FASTMATH": "0"}
    ):
        import sktime._vendor.skchange.utils.numba  # noqa: F401, I001
...
def test_njit_function():
    from sktime._vendor.skchange.utils.numba import njit
...
def test_jit_function():
    from sktime._vendor.skchange.utils.numba import jit
...
def test_prange_function():
    from sktime._vendor.skchange.utils.numba import njit, prange
