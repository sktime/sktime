# -*- coding: utf-8 -*-
"""
Base class template for annotator base types:
 - BaseStreamAnnotator - annotating a data stream, with temporal update
 - BasePanelAnnotator - annotating a panel of sequences or time series

 Class summaries below:

---

    class name: BasePanelAnnotator

Scitype defining methods:
    fitting              - fit(self, X, Y=None, Z=None)
    annotating           - predict(self, X, Z=None)

    NOT YET IMPLEMENTED
    updating (minibatch) - update(self, X, Y=None, Z=None)
    update&annotate      - update_predict(self, X, X_new, Y=None, Z=None, Z_new=None)
...
---
    ...
    class name: BaseStreamAnnotator
...
class BasePanelAnnotator(BaseEstimator):
    """Base annotator
    ...
    # default tags
    _tags = {
        "handles-panel": True,  # can handle panel annotations, i.e., list X/y?
    ...
    def __init__(self):
        ...
        super(BasePanelAnnotator, self).__init__()
...
class BaseStreamAnnotator(BaseEstimator):
    ...
    def __init__(self):
        ...
        super(BaseStreamAnnotator, self).__init__()
