...
def _delegate(func):
    ...
    def inner(self, **kwargs):
        return func(self._delegate, **kwargs)

    return inner


class BasePolymorphByDelegation(BaseObject):
    """Handles parameter management for estimators composed of named estimators.
    ...
    def __init__(self, estimator_type="base"):
        ...
        self.estimator_type = estimator_type
        baseclass = _check_estimator_types(estimator_type)[0]
        self._delegate = baseclass

        super(BasePolymorphByDelegation, self).__init__()
        ...
        for attr in attr_to_copy:
            setattr(self, attr, _delegate(getattr(baseclass, attr)))
...
class RocketClassifier(BasePolymorphByDelegation):
    ...
    def __init__(
        ...
        super(RocketClassifier, self).__init__("classifier")
