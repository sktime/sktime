"""Base module for deep learning classifiers in sktime.

This module provides abstract base classes for implementing deep learning
classifiers using Keras. It includes definitions for methods such as building
models, predicting probabilities, and serialization.
"""
