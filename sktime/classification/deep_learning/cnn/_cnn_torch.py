"""Time Convolutional Neural Network (CNN) for classification in PyTorch."""
...
class CNNClassifierTorch(BaseDeepClassifierPytorch):
    """Time Convolutional Neural Network in PyTorch for time series classification.
    ...
    Adapted from the TensorFlow CNN classifier. Same defaults as the TensorFlow
    ...
    criterion : str or None or loss instance, default = "CrossEntropyLoss"
    ...
    >>> clf = CNNClassifierTorch(n_epochs=20, batch_size=4)  # doctest: +SKIP
