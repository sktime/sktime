# -*- coding: utf-8 -*-
"""Encoder Neural Network for classification."""
...
class EncoderClassifier(BaseDeepClassifier):
    """Encoder Neural Network (CNN), as described in [1].
    ...
    Examples
    --------
    >>> from sktime.classification.deep_learning.encoder import EncoderClassifier
