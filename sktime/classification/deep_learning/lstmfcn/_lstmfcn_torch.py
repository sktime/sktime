...
class LSTMFCNClassifierTorch(BaseDeepClassifierPytorch):
    """LSTM-FCN classifier for time series classification in PyTorch.
    ...
    >>> clf = LSTMFCNClassifierTorch(num_epochs=50, batch_size=128)  # doctest: +SKIP
    ...
    def _build_network(self, X, y):
        ...
        if self.num_classes == 1:
            warnings.warn("single label", UserWarning)
