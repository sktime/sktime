"""ResNet classifier for time series in PyTorch."""
...
class ResNetClassifierTorch(BaseDeepClassifierPytorch):
    """Residual Network (ResNet) for time series classification in PyTorch.
    ...
    criterion : str or None or instance of torch loss, default = None
    ...
    >>> clf = ResNetClassifierTorch(num_epochs=10, batch_size=4) # doctest: +SKIP
