...
class TestCNNClassifier:
    ...
    def test_cnn_basic_functionality(self):
        ...
        cnn = CNNClassifier(n_epochs=2, batch_size=4, verbose=False)
    ...
    def test_cnn_pytorch_import(self):
        ...
        cnn = CNNClassifier(n_epochs=1, batch_size=2)
