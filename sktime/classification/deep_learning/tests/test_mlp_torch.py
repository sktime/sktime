...
def create_synthetic_timeseries_data(n_samples=100, n_features=10, n_timesteps=50, n_classes=3):
...
class TestMLPTorchClassifier:
    ...
    def test_mlp_torch_classifier_basic(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=50, n_features=5, n_timesteps=20, n_classes=2)
    ...
    def test_mlp_torch_classifier_multiclass(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=60, n_features=3, n_timesteps=15, n_classes=3)
    ...
    def test_mlp_torch_classifier_parameters(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=40, n_features=4, n_timesteps=25, n_classes=2)
    ...
    def test_mlp_torch_classifier_configurable(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=30, n_features=3, n_timesteps=10, n_classes=2)
