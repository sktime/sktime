...
def get_classifiers(threads_to_use):
    ...
    clfs = {
        ...
        "WEASEL 2 (chi2, 60, 4)": WEASEL_STEROIDS(
            random_state=1379,
        ...
        #     n_jobs=threads_to_use,
        # ),
        # "WEASEL 2 (chi2, 60, 4, 6-8)": WEASEL_STEROIDS(
        #     random_state=1379,
        #     binning_strategies=["equi-depth"],
        #     alphabet_sizes=[4],
        #     lower_bounding=False,
        ...
        #     n_jobs=threads_to_use,
        # ),
        # "WEASEL 2 (chi2, 60, 2-4)": WEASEL_STEROIDS(
        #     random_state=1379,
        #     binning_strategies=["equi-depth"],
        #     alphabet_sizes=[2, 4],
        #     lower_bounding=False,
        ...
        #     n_jobs=threads_to_use,
        # ),
        # "WEASEL 2 (chi2, 60, 2-4, diffs)": WEASEL_STEROIDS(
        #     random_state=1379,
        #     binning_strategies=["equi-depth"],
        #     alphabet_sizes=[2, 4],
        #     lower_bounding=False,
        ...
        #     n_jobs=threads_to_use,
        # ),
        # "WEASEL 2 (chi2, 60, sections4)": WEASEL_STEROIDS(
        #     random_state=1379,
        #     binning_strategies=["equi-depth"],
        #     alphabet_sizes=[4],
        #     lower_bounding=False,
