...
def get_classifiers(threads_to_use):
    ...
    clfs = {
        ...
        "BOSS (final, boss-distance)": BOSSEnsemble(
            random_state=1379, use_boss_distance=True, n_jobs=threads_to_use
        ),
        # "BOSS (final, ED)": BOSSEnsemble(
        #     random_state=1379,
        ...
        #     random_state=1379,
        #     n_jobs=threads_to_use),
        # "BOSS (none)": BOSSEnsemble(
        #      random_state=1379,
        #      n_jobs=threads_to_use,
        #     # feature_selection="chi2"
        # ),
        # "BOSS (chi2)": BOSSEnsemble(
        #     random_state=1379,
        #     n_jobs=threads_to_use,
        #     feature_selection="chi2"
        # ),
...
if __name__ == "__main__":
    ...
    if server:
        ...
        ).to_csv("classifier_all_scores_boss.csv", index=None)
        ...
        ).to_csv("classifier_all_runtimes_boss.csv", index=None)
