...
def test_teaser_full_length():
    ...
    testing.assert_allclose(acc, 0.864, rtol=0.01)
    testing.assert_allclose(earl, 0.773, rtol=0.01)

    testing.assert_allclose(teaser._train_accuracy, 0.95, rtol=0.01)
    testing.assert_allclose(teaser._train_earliness, 0.699, rtol=0.01)
