...
#     NOTE: This model can only handle time series with a sequence length of 512 or
...
#             y, X, train_size=1 - self.train_val_split, test_size=self.train_val_spl
#         )

#         # if we need to transform the labels, do it here
#         y_train, y_test, mapping, inverse_mapping = _transform_labels(y_train, y_tes
...
#             Name of the set of test parameters to return, for use in tests. If n
#             special parameters are defined for a value, will return `"default"` se

#         Returns
#         -------
#         params : dict or list of dict, default = {}
#             Parameters to create testing instances of the class
#             Each dict are parameters to construct an "interesting" test instance, i.
#             `MyClass(**params)` or `MyClass(**params[i])` creates a valid test insta
#             `create_test_instance` uses the first (or only) dictionary in `param
#         """
#         params_set = []
#         params1 = {"to_cpu_after_fit": True, "train_val_split": 0.0, "batch_size": 6
...
#             if not is_built():
#                 print(
#                     "MPS not available because the current PyTorch install was n
#                     "built with MPS enabled."
#                 )
#             else:
#                 print(
#                     "MPS not available because the current MacOS version is not 12.3
#                     "and/or you do not have an MPS-enabled device on this machin
#                 )
#         else:
#             _device = "mps"
#             mps = True
