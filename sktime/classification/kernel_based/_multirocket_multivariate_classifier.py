...
class MultiRocketMultivariateClassifier(BaseClassifier):
    """Classifier wrapped for the MultiRocket multivariate transformer using RidgeClassifierCV.
    ...
    Attributes
    ----------
    classifier              : MultiRocket multivariate classifier
    ...
    def __init__(
        ...
        super(MultiRocketMultivariateClassifier, self).__init__()
