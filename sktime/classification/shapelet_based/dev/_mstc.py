...
"""
from sktime.classification.shapelet_based.dev.factories.shapelet_factory import ShapeletFactoryIndependent

__author__ = "Alejandro Pasos Ruiz"
__all__ = ["RandomFilter", "ShapeletFactory", "ShapeletFactoryIndependent", "ShapeletFactoryDeoebdent"]
...
class MultivariateShapeletTransformClassifier(BaseClassifier):
    """Multivariate Shapelet Transform Classifier.
    ...
    def __init__(
        ...
        super(MultivariateShapeletTransformClassifier, self).__init__()
    ...
    def fit(self, X, y):
        ...
        max_shapelet = X.applymap(lambda x: len(x)).to_numpy().min()
            ...
            [
                (
                    ...
                    RandomFilter(
                        ...
                        max_shapelet_length=max_shapelet,
                        num_shapelets=10*n if 10*n < 1000 else 1000,
