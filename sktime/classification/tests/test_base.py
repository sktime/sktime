...
def test_convert_input():
    ...
    tempX, tempy = tester.convert_X_y(test_X1, test_y1)
    assert tempX.shape[0] == 5 and tempX.shape[1] == 1 and tempX.shape[2] == 10
    tempX, tempy = tester.convert_X_y(test_X2, test_y1)
    ...
    tempX, tempy = tester.convert_X_y(test_X3, test_y1)
    assert tempX.shape[0] == 5 and tempX.shape[1] == 1 and tempX.shape[2] == 10
    tempX, tempy = tester.convert_X_y(test_X4, test_y1)
