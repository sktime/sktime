...
from sktime.classification.shapelet_based.dev import MultivariateShapeletTransformClassifier
...
def set_classifier(cls, resampleId=None):
    ...
    # Shapelet based
        ...
        return MultivariateShapeletTransformClassifier(
            random_state=resampleId, transform_contract_in_mins=300
        )
...
if __name__ == "__main__":
    ...
    if sys.argv.__len__() > 1:  # cluster run, this is fragile
        ...
        results_dir = "C:/Users/fbu19zru/code/sktime_results/shapelets/sktime/"
