...
class ColumnEnsembler(BaseClassifier):
    """Applies estimatos to columns of an array or pandas DataFrame.
    ...
    def _collect_probas(self, X):
        return np.asarray([estim.predict_proba(_get_column(X, column)) for (name, estim, column) in self._iter(replace_strings=True)])
