...
# WORKSHOP NOTE:
# this is the original shapelet transform that is currently on sktime master/dev.
# It is limited, i.e.
#   - non-binary info gain
#   - no distance early abandon
#   - univariate
#
# This was extended to shapelets_v2 which includes some of the above, but in practice on large data it
# was very slow (hence v3 that is a start at rectifying some of these!)
