#!/usr/bin/env python3
"""Causal Pricing Data Generator.

Implements the synthetic data generator from Schultz et al. (2024),
"Causal Forecasting for Pricing" (arXiv:2312.15282).
"""

__author__ = ["XAheli", "geetu040"]
__all__ = ["make_causal_pricing"]
