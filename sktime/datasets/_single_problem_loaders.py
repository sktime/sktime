...
def load_tecator(split=None, return_X_y=True, return_type=None):
    ...
    This dataset measures the fat content of meat based off its infrared absorbance
    spectrum. The absorbance spectrum is measured in the wavelength range of 850 nm to
    1050 nm. The fat content is measured by standard chemical analysis methods.
    The dataset contains 215 samples of meat, each with 100 spectral measurements.
    More info: https://www.openml.org/search?type=data&sort=runs&id=505&status=active
    ...
    The Tecator dataset measures the fat content of meat based off its near
    infrared absorbance spectrum. The absorbance spectrum is measured in the wavelength
    range of 850 nm to 1050 nm. The fat content is measured by standard chemical
    analysis methods.  The dataset contains 215 samples of meat, each with 100
    spectral measurements. For more information see:
