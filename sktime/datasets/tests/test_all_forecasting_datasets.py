...
class ForecastingDatasetFixtureGenerator(BaseFixtureGenerator):
    ...
    object_type_filter = "dataset_forecasting"
...
class TestAllForecastingDatasets(ForecastingDatasetFixtureGenerator, QuickTester):
    ...
    def test_tag_is_one_series(self, object_instance):
        expected = object_instance.get_tag("is_one_series")
    ...
    def test_tag_n_panels(self, object_instance):
        expected = object_instance.get_tag("n_panels")
        y = object_instance.load("y")
    ...
    def test_tag_n_hierarchy_levels(self, object_instance):
        expected = object_instance.get_tag("n_hierarchy_levels")
        y = object_instance.load("y")
    ...
    def test_tag_constraints(self, object_instance):
        tags = object_instance.get_tags()
