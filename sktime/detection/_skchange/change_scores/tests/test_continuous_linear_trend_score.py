...
from sktime.detection._skchange.change_detectors import MovingWindow, SeededBinarySegmentation
...
from sktime.detection._skchange.datasets import generate_continuous_piecewise_linear_signal
