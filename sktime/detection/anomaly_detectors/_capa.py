...
def _make_nonlinear_chi2_penalty_from_score(score) -> np.ndarray:
    ...
    from sktime.detection.penalties import make_nonlinear_chi2_penalty
...
class CAPA(BaseSegmentAnomalyDetector):
    ...
    >>> from sktime._vendor.skchange.datasets import generate_piecewise_normal_data
    ...
    def get_test_params(cls, parameter_set="default"):
        ...
        """
        from sktime.detection.compose.penalised_score import PenalisedScore
