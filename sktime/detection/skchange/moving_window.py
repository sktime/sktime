...
class MovingWindow(BaseDetector):
    ...
    This implementation is provided by skchange.skchange.change_detectors.moving_window.
    ...
    def __init__(
        ...
        warn(
            "This is a placeholder. To use the full functionality of the MovingWindow "
            "detector, please install skchange>=0.6.0."
        )
