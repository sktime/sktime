...
def test_setting_wrong_env_variable_raises():
    with (
        ...
        import sktime.detection.utils.numba  # noqa: F401, I001
...
def test_njit_function():
    from sktime.detection.utils.numba import njit
...
def test_jit_function():
    from sktime.detection.utils.numba import jit
...
def test_prange_function():
    from sktime.detection.utils.numba import njit, prange
