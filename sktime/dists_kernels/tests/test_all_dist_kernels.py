...
class TransformerPairwiseFixtureGenerator(BaseFixtureGenerator):
    ...
    object_type_filter = "transformer-pairwise"
...
class TestAllPairwiseTransformers(TransformerPairwiseFixtureGenerator, QuickTester):
    ...
    def test_pairwise_transformers_tabular(self, object_instance, scenario):
...
class TransformerPairwisePanelFixtureGenerator(BaseFixtureGenerator):
    ...
    object_type_filter = "transformer-pairwise-panel"
...
class TestAllPanelTransformers(TransformerPairwisePanelFixtureGenerator, QuickTester):
    ...
    def test_pairwise_transformers_panel(self, object_instance, scenario):
        """Main test function for pairwise transformers on tabular data."""
        trafo_name = type(object_instance).__name__
        dist_mat = scenario.run(object_instance, method_sequence=["transform"])
    ...
    def test_transform_diag(self, object_instance, scenario):
        ...
        trafo_name = type(object_instance).__name__
        diag_vec = scenario.run(object_instance, method_sequence=["transform_diag"])
