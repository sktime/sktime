...
class AutoAR(BaseStatsModelsAdapter):
    ...
    hold_back : {None, int}
        ...
        the model.
    sp : {None, int}
        The seasonal periodicity of the data. Only used if seasonal is True. This parameter
    ...
    def __init__(self, maxlag=10, trend='c', seasonal=False, hold_back=None, sp=None, missing='none',
                 ic="aic", glob=False):
        self.maxlag = maxlag
        self.trend = trend
