...
Tests cover the basic operations of the FallbackForecaster, ensuring proper functionality
of fitting, predicting, updating, and handling of errors in the forecasting process."""
...
class DummyForecaster(_HeterogenousMetaEstimator, BaseForecaster):
    ...
    This forecaster is intentionally designed to fail at specified stages of the forecasting
    process (fit, predict, or update) to test the robustness and fallback mechanisms of the
    FallbackForecaster.

    Parameters
    ----------
    raise_at : str
        Stage at which the forecaster should fail. Options are "fit", "predict", "update".
