...
class CutoffSplitter(BaseSplitter):
    ...
    def _split(self, y):
        ...
        window_length = check_window_length(self.window_length, y)
...
class BaseWindowSplitter(BaseSplitter):
    ...
    def _split(self, y):
        ...
        window_length = check_window_length(self.window_length, y, "window_length")
        initial_window = check_window_length(self.initial_window, y, "initial_window")
        fh = _check_fh(self.fh)
