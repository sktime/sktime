...
class CutoffSplitter(BaseSplitter):
    ...
    def _split(self, y):
        ...
        window_length = check_window_length(y, self.window_length)
...
class BaseWindowSplitter(BaseSplitter):
    ...
    def _split(self, y):
        ...
        window_length = check_window_length(y, self.window_length, "window_length")
        initial_window = check_window_length(y, self.initial_window, "initial_window")
        fh = _check_fh(self.fh)
