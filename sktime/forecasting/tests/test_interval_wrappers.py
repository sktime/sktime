...
def test_wrapper_series_mtype(wrapper, override_y_mtype, mtype):
    ...
    """
    # Since GluonTS does not provide clean access to data within its objects
    # we cannot run this test on the gluonTS dataypes
    if mtype in ["gluonts_ListDataset_series", "gluonts_PandasDataset_series"]:
        return None
