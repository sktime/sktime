"""Python implementation of Timer-S1.

Unofficial fork of the ``bytedance-research/Timer-S1`` model code from huggingface,
available at https://huggingface.co/bytedance-research/Timer-S1.

sktime migration: 2026, Jun
Version 8911430cc7f32add5c8913afe12e3b05742f5bb2 release: 2026, Apr (Yong Liu)
