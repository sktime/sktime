    ...
    **kwargs
    ...
    class _AttentionLSTMCell(Layer):
        ...
        # References
            ...
            Visual Attention"](http://arxiv.org/pdf/1502.03044.pdf)
        """
    ...
    **kwargs
    ...
    class _AttentionLSTM(RNN):
        ...
        def recurrent_activation(self):
            """Return recurrent activation function."""
        ...
        def unit_forget_bias(self):
            """Return unit forget bias."""
            return self.cell.unit_forget_bias

        @property
        def kernel_regularizer(self):
            """Return kernel regularizer."""
            return self.cell.kernel_regularizer

        @property
        def recurrent_regularizer(self):
            """Return recurrent regularizer."""
            return self.cell.recurrent_regularizer

        @property
        def bias_regularizer(self):
            """Return bias regularizer."""
            return self.cell.bias_regularizer

        @property
        def activity_regularizer(self):
            """Return activity regularizer."""
            return self.cell.activity_regularizer

        @property
        def attention_regularizer(self):
            """Return attention regularizer."""
