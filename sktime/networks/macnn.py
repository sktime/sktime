...
class MACNNNetwork(BaseDeepNetwork):
    ...
    def _macnn_block(self, x, kernels, reduce):
        """
        Implementation of a single MACNN Block.
        ...
        x2 = reduce_mean(x1, 1)
        x2 = keras.layers.Dense(int(kernels * 3 / reduce), use_bias=False, activation='relu')(x2)
    ...
    def _stack(self, x, repeats, kernels, reduce):
        """
        Helper function to build MACNN Blocks.
