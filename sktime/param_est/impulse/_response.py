...
class ImpulseResponseFunction(BaseParamFitter):
    ...
    def fit(self, X) -> np.ndarray:
        ...
        cases of VAR and SARIMAX models), while for time-varying models the impulse responses 
        are only given for steps elements (to avoid having to unexpectedly provide updated 
