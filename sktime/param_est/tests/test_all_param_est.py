...
class TestAllParamFitters(ParamFitterFixtureGenerator, QuickTester):
    ...
    def test_get_fitted_params(self, object_instance, scenario):
        ...
        gfp_ret = object_instance.get_fitted_params()
    ...
    def test_update(self, object_instance):
        ...
        object_instance.fit(X1)

        gfp_ret = object_instance.get_fitted_params()
        assert isinstance(gfp_ret, dict)

        object_instance.update(X2)

        gfp_ret = object_instance.get_fitted_params()
        assert isinstance(gfp_ret, dict)

        object_instance.update(X3)
