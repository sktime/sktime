...
#
#st_model = statsdyn(df, k_factors=1, factor_order=2, error_order=2, enforce_stationarity=False)
#fitted_model = st_model.fit()
#stats_res = fitted_model.impulse_responses()
#print(stats_res.sum().sum())
#
...
#sktime_res.fit(df)
#print(sktime_res.get_fitted_params()["irf"].sum())
#
#print("#####################")
#
