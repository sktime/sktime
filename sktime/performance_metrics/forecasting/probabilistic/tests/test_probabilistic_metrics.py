...
fh_uni = ForecastingHorizon(np.arange(len(y_test_uni)) + 1, freq=y_uni.index.freqstr)
...
fh_multi = ForecastingHorizon(
    np.arange(len(y_test_multi)) + 1, freq=y_multi.index.freqstr
)
