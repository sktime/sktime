...
class ForecastingMetricPtFixtureGenerator(BaseFixtureGenerator):
    ...
    object_type_filter = "metric_forecasting"
...
class TestAllForecastingPtMetrics(ForecastingMetricPtFixtureGenerator, QuickTester):
    ...
    def test_metric_output_direct(self, object_instance, multioutput, n_columns):
        ...
        metric = object_instance.set_params(multioutput=multioutput)
    ...
    def test_uniform_average_time(self, object_instance):
        """Tests that uniform_average_time indeed ignores index."""
        metric_obj = object_instance.set_params(multilevel="uniform_average_time")
    ...
    def test_metric_weights(self, object_instance):
        """Test that weights are correctly applied to the metric."""
        metric_obj = object_instance
