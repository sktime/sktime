"""Base module for deep learning regressors in sktime.

This module provides an abstract base class for implementing deep learning
regressors using Keras. It includes functionality for model building, prediction,
