...
class MACNNRegressorTorch(BaseDeepRegressorTorch):
    """Multi-Scale Attention Convolutional Neural Network (MACNN) regressor in PyTorch.

    This regressor implements a multi-scale attention mechanism that learns feature
    ...
    >>> reg = MACNNRegressorTorch(num_epochs=50, batch_size=2)  # doctest: +SKIP
