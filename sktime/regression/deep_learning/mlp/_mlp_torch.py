"""MLP (Multi-Layer Perceptron) Regressor for Time Series Regression in PyTorch."""
...
class MLPRegressorTorch(BaseDeepRegressorTorch):
    """Multi Layer Perceptron regressor in PyTorch for time series regression.

    A simple MLP regressor based on MLP network defined in [1]_.
    ...
    >>> reg = MLPRegressorTorch(num_epochs=50, batch_size=2) # doctest: +SKIP
    ...
    def get_test_params(cls, parameter_set="default"):
        ...
        params3 = {
            ...
            "verbose": False,
            "random_state": 0,
        }  # using L1Loss as an alternative regression loss
