"""Multi Layer Perceptron (MLP) for regression in PyTorch."""
...
class MLPRegressorTorch(BaseDeepRegressorTorch):
    ...
    loss : case insensitive str or None or an instance of a loss function
    ...
    activation : str or None or an instance of activation functions defined in
        ...
        Activation function used in the output layer. None means linear (no activation).
    ...
    >>> regressor = MLPRegressorTorch() # doctest: +SKIP
