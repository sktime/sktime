"""Time Series Attentional Prototype Network (TapNet) regressor in PyTorch."""

__authors__ = ["dakshpathak"]
__all__ = ["TapNetRegressorTorch"]
...
class TapNetRegressorTorch(BaseDeepRegressorTorch):
    """Time series attentional prototype network (TapNet) regressor in PyTorch.

    TapNet was initially proposed for multivariate time series
    classification [1]_. This is an adaptation for time series regression.
    TapNet comprises these components: random dimension permutation,
    ...
    >>> tapnet = TapNetRegressorTorch(num_epochs=20, batch_size=4)  # doctest: +SKIP
    ...
    def __init__(
        ...
        # For regression, always 1 output
        self.num_classes = 1
