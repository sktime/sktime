...
class TestMLPTorchRegressor:
    ...
    def test_mlp_torch_regressor_basic(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=50, n_features=5, n_timesteps=20)
    ...
    def test_mlp_torch_regressor_configurable(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=30, n_features=3, n_timesteps=10)
    ...
    def test_mlp_torch_regressor_loss_functions(self):
        ...
        X, y = create_synthetic_timeseries_data(n_samples=20, n_features=2, n_timesteps=10)
