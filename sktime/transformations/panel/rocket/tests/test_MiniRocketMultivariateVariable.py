...
def test_minirocket_multivariate_variable_on_japanese_vowels():
    ...
    num_kernels=10_000
    minirocket_mv_var = MiniRocketMultivariateVariable(num_kernels=num_kernels, random_state=42)
    ...
    np.testing.assert_equal(X_training_transform.shape, (len(X_training), 84*(num_kernels//84)))
    ...
    np.testing.assert_equal(X_test_transform.shape, (len(X_test), 84*(num_kernels//84)))
