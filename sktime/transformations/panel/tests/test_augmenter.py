...
def _train_test(data, augmenter):
    X_tr, X_te, y_tr, y_te = data
    # fit augmenter object (if necessary)
    augmenter.fit(X_tr, y_tr)
    # transform new data with (fitted) augmenter
    Xt = augmenter.transform(X_te, y_te)
...
def test_invert(parameter):
    ...
    checksums = []
    for para in parameter:
        augmenter = aug.InvertAugmenter(**para)
        Xt = _train_test(data, augmenter)
        checksum = _calc_checksum(Xt)
        checksums.append(checksum)
        shapes.append(data[0].shape)
...
def test_reverse(parameter):
    ...
    checksums = []
    for para in parameter:
        augmenter = aug.ReverseAugmenter(**para)
        Xt = _train_test(data, augmenter)
        checksum = _calc_checksum(Xt)
        checksums.append(checksum)
        shapes.append(data[0].shape)
...
#     checksums = []
#     for para in parameter:
#         augmenter = aug.ScaleAugmenter(**para)
#         Xt = _train_test(data, augmenter)
#         checksum = _calc_checksum(Xt)
#         checksums.append(checksum)
#         shapes.append(data[0].shape)
...
#     checksums = []
#     for para in parameter:
#         augmenter = aug.OffsetAugmenter(**para)
#         Xt = _train_test(data, augmenter)
#         Xt = _train_test(data, augmenter)
#         checksum = _calc_checksum(Xt)
#         checksums.append(checksum)
...
#     checksums = []
#     for para in parameter:
#         augmenter = aug.DriftAugmenter(**para)
#         Xt = _train_test(data, augmenter)
#         checksum = _calc_checksum(Xt)
#         checksums.append(checksum)
#         shapes.append(data[0].shape)
