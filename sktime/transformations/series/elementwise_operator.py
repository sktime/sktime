...
class ElementWiseArithmeticOperator(BaseTransformer, _HeterogenousMetaEstimator):
    """Custom transformer for element-wise arithmetic operations.

    This transformer applies a specified arithmetic operation element-wise
    to the input time series data. It can be used to perform operations such
    as addition, subtraction, multiplication, or division on the input data.
