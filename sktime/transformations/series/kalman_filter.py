...
Series based transformers, based on Kalman Filter algorithm. Contains Base class and 3
transformers which are each Adapters for external packages pykalman, FilterPy, and simdkalman.
"""
