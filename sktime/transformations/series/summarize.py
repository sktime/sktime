...
class WindowSummarizer(BaseTransformer):
    """Transformer for extracting features across (shifted) windows from series.
    ...
    truncate_start_ : int
        ...
        A lag_config of [[7, 14], [0, 28]] cannot be correctly applied for the
        first 21 resp. 28 observations of  the targeted column. truncate_start_ will
    ...
    def _fit(self, X, y=None):
        ...
        self.truncate_start_ = func_dict["window"].apply(lambda x: x[0] + x[1]).max()
