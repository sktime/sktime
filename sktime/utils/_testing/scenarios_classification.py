...
class ClassifierTestScenario(TestScenario, BaseObject):
    ...
    def is_applicable(self, obj):
        ...
        # applicable only if obj inherits from BaseClassifier
        if not isinstance(obj, BaseClassifier) and not issubclass(obj, BaseClassifier):
            return False
...
class ClassifierFitPredictMultivariate(ClassifierTestScenario):
    ...
    _tags = {"X_univariate": False, "pre-refactor": True}
