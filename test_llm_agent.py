...
def test_basic_fit_predict():
    ...
    mock_llm = lambda prompt: '{"estimator": "NaiveForecaster", "params": {"strategy": "mean"}, "explanation": "Fallback Naive model due to missing info."}'
    
    agent = LLMForecaster(prompt="Use a Naive model to forecast the next 12 periods.", llm=mock_llm)
